  ...
  const textContent = below800 ? (
    <div>
      <Text fontWeight={500} lineHeight={'145.23%'} mt={'10px'}>
        Anyone can create and name any ERC20 token on FRA, including creating fake versions of existing tokens and
        tokens that claim to represent projects that do not have a token.
      </Text>
      <Text fontWeight={500} lineHeight={'145.23%'} mt={'10px'}>
        Similar to FRAscan, this site automatically tracks analytics for all ERC20 tokens independent of token
      ...
      <Text fontWeight={500} lineHeight={'145.23%'} mt={'10px'}>
        Anyone can create and name any ERC20 token on FRA, including creating fake versions of existing tokens and
        tokens that claim to represent projects that do not have a token. Similar to FRAscan, this site automatically
          ...
          <div>
            <Hover style={{ marginTop: '10px' }}>
              <Link
                ...
                lineHeight={'145.23%'}
                color={'#2172E5'}
                href={'http://blockscout.findorascan.io/address/' + address}
                target="_blank"
              >
                View {type === 'token' ? 'token' : 'pair'} contract on FRAscan
              </Link>
            </Hover>
