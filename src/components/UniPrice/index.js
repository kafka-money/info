...
export default function UniPrice() {
  const daiPair = usePairData('0xa53ddf0683181343aac560d651ca73c5e3868a97')
  const usdcPair = usePairData('0x4246d2eaad1c0b254b2802a94f0d344cfd7731eb')
  const usdtPair = usePairData('0xfeb9ba7eb8cb27287263135ec47c410857725f2a')
  ...
  return (
    <PriceCard>
      <AutoColumn gap="10px">
         <RowFixed>
          <TYPE.main>DAI/FRA: {formattedNum(daiPerEth, true)}</TYPE.main>
          <TYPE.light style={{ marginLeft: '10px' }}>
            {daiPair && totalLiquidity ? formatPercent(daiPair.trackedReserveUSD / totalLiquidity) : '-'}
          </TYPE.light>
        </RowFixed>
        <RowFixed>
          <TYPE.main>USDC/FRA: {formattedNum(usdcPerEth, true)}</TYPE.main>
          <TYPE.light style={{ marginLeft: '10px' }}>
            {usdcPair && totalLiquidity ? formatPercent(usdcPair.trackedReserveUSD / totalLiquidity) : '-'}
          </TYPE.light>
        </RowFixed> 
        <RowFixed>
          <TYPE.main>USDT/FRA: {formattedNum(usdtPerEth, true)}</TYPE.main>
          <TYPE.light style={{ marginLeft: '10px' }}>
